...
namespace WebDev.Application.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController()
        {
            ...
            {
                new User{Id=1, Email="totoroldan12@email.com", Name="Jonathan Asprilla", Username="totoaspri11a", Password="todaslascontraseñas"},
                new User{Id=2, Email="Pilar.Lopez@email.com", Name="Pilar Lopez", Username="plopez", Password="Password"},
                new User{Id=3, Email="tarzan42@email.com", Name="Tarzan Junglero", Username="jungleroChido", Password="JungleRocks"},
            };
